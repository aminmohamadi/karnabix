            ...
            <div class="col-lg-2 responsive-column-half">
                <div class="footer-item">
                    ...
                    <ul class="generic-list-item">
                        ...
                        <li><a href="{{ route('exams') }}">آزمون های مهارت سنجی</a></li>
                        <li><a href="{{ route('advertises') }}">آگهی های استخدام</a></li>
                    </ul>
                </div>
                <!-- end footer-item -->
            </div>
    ...
    <div class="copyright-content py-4">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-3">شماره تماس : <a href="tel:{{$tel}}">{{$tel}}</a></div>
                <div class="col-3">ایمیل : <a href="mailto:{{$email}}">{{$email}}</a></div>
            </div>
            <!-- end row -->
        </div>
        <!-- end container -->

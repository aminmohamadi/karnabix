<div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
    ...
    <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
        ...
        @role('sale')
        <x-site.client.sidebar-link title="پنل فروش" link="{{ route('sale.dashboard') }}" icon="la la-chalkboard-teacher pr-2" :active="request()->routeIs('teacher.dashboard')" />
        @endif
        ...
        <x-site.client.sidebar-link title=" دوره های خریداری شده" link="{{ route('user.courses') }}" icon="la la-file pr-2" :active="request()->routeIs('user.courses')" />

    ...
    <div class="space-y-8">
        ...
        <div class="flex items-center gap-5 bg-gradient-to-l from-secondary to-background rounded-2xl p-5">
            ...
            <div class="flex flex-col space-y-2">
                <span class="font-black xs:text-2xl text-lg text-primary">آگهی های استخدام</span>
                <span class="font-semibold text-xs text-muted">وارد دنیای کار شو</span>
            </div>
        </div>
        <!-- end section:title -->
        ...
        <div class="grid md:grid-cols-12 grid-cols-1 items-start gap-5">
            <div class="md:block hidden lg:col-span-3 md:col-span-4 md:sticky md:top-24">
                <div class="w-full flex flex-col space-y-3 mb-3">
                    <span class="font-bold text-sm text-foreground">جستجو آگهی</span>
                        ...
                        <button type="button"
                                ...
                                x-on:click="open = !open">
                                        <span class="flex items-center gap-x-2">
                                            ...
                                            <span class="font-semibold text-sm text-right">بر اساس نوع شغل </span>
                                        </span>
                    ...
                    <div x-cloak>
                        <div
                            ...
                            <div
                                ...
                                <div class="font-bold text-sm text-foreground">فیلتر مقالات</div>

    ...
    <div class="space-y-8">
        ...
        <div class="flex items-center gap-5 bg-gradient-to-l from-secondary to-background rounded-2xl p-5">
            ...
            <div class="flex flex-col space-y-2">
                <span class="font-black xs:text-2xl text-lg text-primary">مقاله های سایت</span>
                <span class="font-semibold text-xs text-muted">از گوشه و اطراف دنیا</span>
            </div>
        </div>
        <!-- end section:title -->

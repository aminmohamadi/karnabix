                    ...
                    <div class="md:w-4/12 w-full md:top-24 space-y-8 block md:hidden">
                        <div class="bg-gradient-to-b from-secondary to-background rounded-2xl px-5 pb-5">
                            ...
                            <ul class="flex flex-wrap items-center gap-5 " style="justify-content: space-evenly">
                                <li>
                                    <a href="https://api.whatsapp.com/send?text={{ route('codes',$course->short_code) }}" target="_blank"
                                ...
                                <li>
                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('codes',$course->short_code) }}" target="_blank"
                                       class="flex items-center justify-center w-12 h-12 bg-secondary rounded-full text-foreground transition-colors hover:text-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="h-5 w-5" viewBox="0 0 50 50">
                                ...
                                <li>
                                    <a href="https://twitter.com/intent/tweet?text={{ route('codes',$course->short_code) }}" target="_blank"
                                       class="flex items-center justify-center w-12 h-12 bg-secondary rounded-full text-foreground transition-colors hover:text-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="h-5 w-5" viewBox="0 0 50 50">
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ route('codes',$course->short_code) }}" target="_blank"
                                       class="flex items-center justify-center w-12 h-12 bg-secondary rounded-full text-foreground transition-colors hover:text-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="h-5 w-5" viewBox="0 0 50 50">
                        ...
                        <div class="grid lg:grid-cols-4 grid-cols-2 gap-5">
                            <div
                                ...
                                <div
                                    ...
                                    <span class="font-bold text-xs text-muted line-clamp-1">مدت آزمون</span>
                                    <span
                                        class="font-bold text-sm text-foreground line-clamp-1">
                                        @if(!is_null($course->quiz))
                                            {{$course->quiz->time}} دقیقه
                                        @else
                                            0
                                        @endif
                                    </span>
                            ...
                            <div
                                ...
                                <div
                                    class="flex flex-col items-center justify-center text-center space-y-1">
                                                <span class="font-bold text-xs text-muted line-clamp-1">تعداد سوالات</span>
                            ...
                            <div
                                ...
                                <div
                                    class="flex flex-col items-center justify-center text-center space-y-1">
                                    <span class="font-bold text-xs text-muted line-clamp-1">گواهی نامه</span>
                                    <span class="font-bold text-sm text-foreground line-clamp-1">
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                      d="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008Z"></path>
                                                        ...
                                                        <div class="flex flex-col items-start">
                                                            ...
                                                            بعد از خرید آزمون به صفحه آزمون ها مراجعه کنید
                                                            </div>

                                                            <div
                                                                class="font-semibold text-xs text-zinc-400">
                                                                جهت شرکت در آزمون به صفحه <a class="text-primary" href="{{route('user.quizzes')}}"> آزمون ها</a> مراجعه کنید
                                                            </div>

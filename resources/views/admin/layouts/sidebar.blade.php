    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                @endcan
                {{-- v3-teacher-requests --}}
                @can('show_salePerson_requests')
                    <x-admin.menu-item  href="{{route('admin.salePersons')}}" icon="fas fa-chalkboard-teacher" :active="request()->routeIs(['admin.salePersons','admin.store.salePersons'])" label=" درخواست های فروشنده" />
                @endcan
                @can('show_salePerson_requests')
                ...
                @can('show_adds')
                    <x-admin.menu-item href="{{route('admin.advertise')}}" icon="fa fa-clock" :active="request()->routeIs(['admin.advertise','admin.store.advertise'])" label="آگهی های استخدام" />
                @endcan
                @can('show_events')
                ...
                @endcan
                @can('show_checkouts_sale')
                    <x-admin.menu-item  href="{{route('admin.sale.checkout')}}" icon="fmenu-icon fab fa-cc-amazon-pay" :active="request()->routeIs(['admin.sale.checkout','admin.store.sale.checkout'])" label="تسویه حساب ها فروشندگان" />
                @endcan

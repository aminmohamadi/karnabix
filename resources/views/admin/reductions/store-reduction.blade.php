        ...
        <div class="card-body">
            <div class="row">
                ...
                <x-admin.forms.input with="6" id="amount" type="number" label="مقدار*"  wire:model.defer="amount"/>
                               ...
                               <x-admin.forms.jtime-picker with="6" id="starts_at" label="تاریخ شروع" wire:model.defer="starts_at"/>
                <x-admin.forms.jtime-picker with="6" id="expires_at" label="تاریخ پایان" wire:model.defer="expires_at"/>

                ...
                <div class="tab-pane fade show active" id="kt_aside_tab_2">
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid px-3 px-lg-10 py-5" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1" data-menu-scroll="1">
                            <!--begin::Menu Nav-->
                            <ul class="menu-nav">
                                <li class="menu-item {{ url()->current() == route('sale.dashboard') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                ...
                                <x-teacher.menu-item  href="{{route('sale.checkouts')}}" icon="fmenu-icon fab fa-cc-amazon-pay" :active="request()->routeIs(['sale.checkouts','sale.store.checkouts'])" label=" تسویه حساب ها " />
                                <x-teacher.menu-item  href="{{route('sale.bankAccounts')}}" icon="fa fa-piggy-bank" :active="request()->routeIs(['sale.bankAccounts','sale.store.bankAccounts'])" label=" حساب های بانکی " />
                                <li class="menu-section">

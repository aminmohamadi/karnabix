<div>
    ...
    <ul class="generic-list-item off-canvas-menu-list pt-2 pb-2 border-bottom border-bottom-gray">
        ...
        <li>
            <a href="{{ route('advertises') }}">آگهی های استخدام</a>
        </li>
        <li>
...
{{--            <a href="{{route('samples')}}">نمونه سوالات </a>--}}
    ...
    @else
        <div class="btn-box px-4 pt-5 text-center">
            <a href="{{route('login-password')}}" class="btn theme-btn theme-btn-sm theme-btn-transparent"><i class="la la-sign-in mr-1"></i>ورود </a>
            <span class="fs-15 font-weight-medium d-inline-block mx-2">یا</span>
            <a href="{{route('registerNew')}}" class="btn theme-btn theme-btn-sm shadow-none"><i class="la la-plus mr-1"></i> ثبت نام</a>
        </div>
    @endif
</div>

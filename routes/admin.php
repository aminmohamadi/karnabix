...
Route::prefix('admin')->middleware(['auth','role:admin'])->group(function (){
    ...
    Route::get('/salePerson/checkouts',App\Http\Controllers\Admin\SalePersonCheckout\IndexSalePersonCheckout::class)->name('admin.sale.checkout');
    Route::get('/salePerson/checkouts/{action}/{id?}',App\Http\Controllers\Admin\SalePersonCheckout\StoreSalePersonCheckout::class)->name('admin.store.sale.checkout');
    ...
    Route::get('/salePersons',App\Http\Controllers\Admin\SalePerson\IndexSalePersonRequest::class)->name('admin.salePersons');
    Route::get('/salePersons/{action}/{id?}',App\Http\Controllers\Admin\SalePerson\StoreSalePerson::class)->name('admin.salePersons.store');

    Route::get('/advertises',App\Http\Controllers\Admin\Advertises\IndexAdvertise::class)->name('admin.advertise');
    Route::get('/advertises/{action}/{id?}',App\Http\Controllers\Admin\Advertises\StoreAdvertise::class)->name('admin.store.advertise');

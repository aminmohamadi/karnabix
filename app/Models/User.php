...
use App\Http\Controllers\Site\Client\SalePerson;
...
class User extends Authenticatable implements Wallet, Confirmable
{
    ...
    public function salePersonCheckout(): HasMany
    {
        return $this->hasMany(SalePersonCheckout::class);
    }
...
// کاربرانی که این کاربر معرف آن‌هاست
    ...
    public function salePersonRequest()
    {
        return $this->hasOne(SalePersonRequest::class);
    }

    public function salePerson()
    {
        return $this->hasOne(\App\Models\SalePerson::class);
    }

    public function salePersonCheckouts(): HasMany
    {
        return $this->hasMany(SalePersonCheckout::class);
    }
    public function referralOrderDetails()
    {
    ...
    {
        return $this->hasMany(Cart::class, 'receiver_id');
    }
}

...
class Sms extends Model
{
    ...
    const TYPES = [
        ...
        'EXAM_PAID' => [
            'key'    => 'exam-paid',
            'string' => 'اطلاع رسانی پرداخت ازمون به کاربر',
            'method' => 'examPaid'
        ],
        'EXAM_RESULT_REJECTED' => [
            'key'    => 'exam-result-rejected',
            'string' => 'اطلاع رسانی رد شدن در آزمون',
            'method' => 'examResultRejected'
        ],
        'EXAM_RESULT_ACCEPTED' => [
            'key'    => 'exam-result-accepted',
            'string' => 'اطلاع رسانی تایید شدن در آزمون',
            'method' => 'examResultAccepted'
        ],
    ];

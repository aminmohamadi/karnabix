...
class ExamRepository implements ExamRepositoryInterface
{
    ...
    public function getAllSite($search = null, $orderBy = null, $type = null, $category = null , $teacher = null, $property = null, $perpage = 9)
    {
        ...
        })->hasCategory()->where('only_exam',1)->paginate($perpage);
    }
    ...
    {
        return Course::latest()->where("only_exam","=",1)->take(10)->get();
    }

    public function getAllSiteCount($search = null , $orderBy = null , $type = null , $category = null , $teacher = null , $property = null,$count = 2){
        return Course::published()->when($type, function($q) use ($type) {
            return match ($type) {
                'free' => $q->where('const_price',0),
                'cash' => $q->where('const_price','>',0),
            ...
            return $q->where('type',$property);
        })->hasCategory()->where('only_exam',1)->count();
    }

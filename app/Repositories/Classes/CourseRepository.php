...
class CourseRepository implements CourseRepositoryInterface
{
    ...
    public function getAllSite($search = null, $orderBy = null, $type = null, $category = null , $teacher = null, $property = null, $count = 2)
    {
        ...
        })->hasCategory()->where('only_exam',0)->paginate($count);
    }
    ...
    {
        return Course::latest()->where("only_exam",0)->take(10)->get();
    }
    ...
    public function getAllSiteCount($search = null , $orderBy = null , $type = null , $category = null , $teacher = null , $property = null,$count = 2){
        return Course::published()->when($type, function($q) use ($type) {
            ...
            return $q->where('type',$property);
        })->hasCategory()->where('only_exam',0)->count();
    }

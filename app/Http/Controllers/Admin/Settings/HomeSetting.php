...
class HomeSetting extends BaseComponent
{
    ...
    public $titleSlider , $slider ,$slider_title, $slider_sub_title,$slider_button_text, $sliderImage , $sliderLink , $sliders = [] , $modeSlider , $row , $view;
    ...
    public function mount()
    {
        ...
        $this->slider_title = $this->settingRepository->getRow('sliderTitle');
        $this->slider_sub_title = $this->settingRepository->getRow('sliderSubTitle');
        $this->slider_button_text = $this->settingRepository->getRow('sliderButtonText');
    }
    ...
    public function store()
    {
        ...
        $this->settingRepository::updateOrCreate(['name' => 'sliderTitle'], ['value' => $this->slider_title ]);
        $this->settingRepository::updateOrCreate(['name' => 'sliderSubTitle'], ['value' => $this->slider_sub_title ]);
        $this->settingRepository::updateOrCreate(['name' => 'sliderButtonText'], ['value' => $this->slider_button_text ]);

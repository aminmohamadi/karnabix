...
class BaseSetting extends BaseComponent
{
    ...
    public function mount()
    {
        ...
        $this->normalUsersCommission = $this->settingRepository->getRow('normalUsersCommission');
    }
    ...
    public function store()
    {
        ...
        $this->settingRepository::updateOrCreate(['name' => 'normalUsersCommission'], ['value' => $this->normalUsersCommission]);

...
class StoreCourse extends BaseComponent
{
    ...
    $teacher ,$onlyExam, $level , $const_price , $status ,$reduction_type ,$reduction_value = 0 , $start_at , $expire_at  , $tags = [];
    ...
    public function mount($action , $id = null)
    {
        ...
        if ($this->mode == self::UPDATE_MODE) {
            ...
            $this->onlyExam = $this->course->only_exam;

...
class SingleExam extends BaseComponent
{
    ...
    public function mount($slug)
    {
        ...
        if (Auth::check()){
            ...
            $this->afl = env('APP_URL')."/register&referral_code=".$this->user->referral_code;
        }
    ...
    public function render()
    {
        ...
        return view('new.exams.single')->extends('new.layouts.app');
    }

...
{
    public  $content , $starter = [] , $box = [] , $raw_content, $tel, $email, $latest_courses;
    ...
    )
    {
        ...
        $this->latest_courses = Course::latest()->take(10)->get();
    }
    ...
    {
        return view('new.home')->extends('new.layouts.app');
    }
}
